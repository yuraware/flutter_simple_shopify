...
part of 'pricing_percentage_value.dart';
...
class _$PricingPercentageValueTearOff {
  ...
  _PricingPercentageValue call({required double percentage}) {
...
class _$_PricingPercentageValue extends _PricingPercentageValue {
  _$_PricingPercentageValue({required this.percentage}) : super._();

  factory _$_PricingPercentageValue.fromJson(Map<String, dynamic> json) =>
      _$_$_PricingPercentageValueFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$_$_PricingPercentageValueToJson(this);
  }
}

abstract class _PricingPercentageValue extends PricingPercentageValue {
  factory _PricingPercentageValue({required double percentage}) =
      _$_PricingPercentageValue;
  _PricingPercentageValue._() : super._();
